...
function findRhythmLine(lines) {
  // A rhythm line should contain multiple rhythm tokens (e.g. "Q E Q Q"),
  // not just a single letter like the string-name "E" used at the start of tab lines.
  const re = /(?:\b[WHQESTX]\.?\b)(?:\s+(?:\b[WHQESTX]\.?\b)){2,}/i; // at least 3 tokens
